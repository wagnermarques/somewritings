...
* Introdução
  ...
  Neste atividade será criado banco de dados, as tabelas os
  relacionamentos.
  ...
  Apesar de este material trazer informações adicionais como variáveis
  em sql o aluno pode ver isso como conhecimento adicional apenas.
...
* Criação das tabelas
  ...
  Lembra de antes dar um create database lojainfo.
  Instruções sql pra utilização do banco e criação das tabelas.  
