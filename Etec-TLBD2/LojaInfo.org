...
* o comando sqlcmd
   Esse comando é só pra demostrar que nosso container sqlserver está
...
*  dropando o banco pra quando quizer comecar do zero
    Essa parte do script serve simplesmente pra dropar o banco
    A gente dropa o banco as vezes quando queremos rodar os nossos
    scripts do zero.
    NANE: drop_database
    INCLUDE: ./sql_scripts/aula_funcoes.sql 
...
* Criacao do Banco de dados
  ...
  #+INCLUDE: "./sql_scripts/Exec_sp_databases.sql"  :only-contents t :src sql 

  Como você pode perceber, o conteúdo do nosso script é simplesmente
  a execução da Store Procedure sp_databases. 
  O resultado é igual o show databases do mysql, por exemplo.

  Bom agora a gente vai rodar o script aula_funcoes.sql. O escript á
  apresentado logo abaixo pra vc conhece-lo.

  Estamos te mostrando só o pedaço do script que cria o banco de
  dados. 

  #+Name: create database
  #+INCLUDE: ./sql_scripts/aula_funcoes.sql :only-contents t :src sql :lines "6

  Rodando sp_databases de novo vc vai ver que o banco foi criado
  

* Criação das tabelas
  
  Instruções sql pra criação das tabelas.
...
nossas tabelas não dá pra usar elas ainda, em uma aplicação, por
exemplo. Vc vai ver o erro de inserir na
tabela uma venda pra um cliente que não existe. :( 
A próxima sessão dessa atividade vai mostrar como resolver isso.

    #+name: testa_tabelas
    #+begin_src sh :results output replace  :exports both
      docker exec sqlserver /opt/mssql-tools/bin/sqlcmd -S localhost -U SA -P Aluno#123 -i /sql_scripts/create_tables_tests.sql
    #+end_src

    INCLUDE: "./sql_scripts/create_tables_tests.sql"
...
* Relacionamentos
  ...
  conhece, claro de tlbd1.
    ...
    #+begin_src sh :results output replace  :exports both
      docker exec sqlserver /opt/mssql-tools/bin/sqlcmd -S localhost -U SA -P Aluno#123 -i /sql_scripts/create_contraints.sql
    #+end_src
    ...
    -------------------------------------------------------------------------------------------------------------------------------- -------------------------------------------------------------------------------------------------------------------------------- ------------------------------- -----------------------
    tb_vendas                                                                                                                        dbo                                                                                                                              user table                      2018-03-11 17:09:38.260
    ...
    -------------------------------------------------------------------------------------------------------------------------------- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    PK__tb_venda__4595B5ABCB2F8095                                                                                                   clustered, unique, primary key located on PRIMARY                                                                                                                                                                  id_venda                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
    ...
    PRIMARY KEY (clustered)                                                                                                                                                                                                                                          PK__tb_venda__4595B5ABCB2F8095                                                                                                   (n/a)         (n/a)         (n/a)          (n/a)                  id_venda                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
    ...
    Name                                                                                                                             Owner                                                                                                                            Type                            Created_datetime       
    -------------------------------------------------------------------------------------------------------------------------------- -------------------------------------------------------------------------------------------------------------------------------- ------------------------------- -----------------------
    tb_vendas_itens                                                                                                                  dbo                                                                                                                              user table                      2018-03-11 17:09:38.263
    ...
    index_name                                                                                                                       index_description                                                                                                                                                                                                  index_keys                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
    -------------------------------------------------------------------------------------------------------------------------------- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    PK__tb_venda__87C9438BD387A30C                                                                                                   clustered, unique, primary key located on PRIMARY                                                                                                                                                                  id_item                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
    ...
    PRIMARY KEY (clustered)                                                                                                                                                                                                                                          PK__tb_venda__87C9438BD387A30C                                                                                                   (n/a)         (n/a)         (n/a)          (n/a)                  id_item                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
...
já que o select mostra que a tabela venda não retornou registros.
    ...
    #+begin_src sh :results output replace  :exports both
      docker exec sqlserver /opt/mssql-tools/bin/sqlcmd -S localhost -U SA -P Aluno#123 -i /sql_scripts/create_constraints_tests.sql
    #+end_src
    ...
    : Msg 547, Level 16, State 1, Server 39dbf20408b6, Line 3
    : The INSERT statement conflicted with the FOREIGN KEY constraint "fk_vda_cli". The conflict occurred in database "lojainfo", table "dbo.tb_clientes", column 'id_cliente'.
...
Tabela de itens da compra do carlos
 ...
 #+TBLFM: @6$5=vsum(@2..@5)
    ...
    #+name: inserts
    #+begin_src sh :results output replace  :exports both
      docker exec sqlserver /opt/mssql-tools/bin/sqlcmd -S localhost -U SA -P Aluno#123 -i /sql_scripts/inserts.sql
    #+end_src
    ...
    ----------- -------------------------------------------------- ---------------------------------------------------------------------------------------------------- --------------- ----------------------------------------------------------------------
              3 Jeferson                                           Aguia Haia 123                                                                                       11-99999-9999   jef@dom.com                                                           
              4 Carlos                                             Aguia Haia 456                                                                                       11-99999-9999   carlos@dom.com                                                        
              5 Ralf                                               Aguia Haia 789                                                                                       11-99999-9999   ralf@dom.com                                                          
    ...
    ----------- -------------------------------------------------- -------------------- ----------- ----------- ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
              7 gabinete                                                             61         100          10 NULL                                                                                                                                                                                                                                                            
              8 processador                                                         301         100          10 NULL                                                                                                                                                                                                                                                            
              9 placa m?e                                                           101         100          10 NULL                                                                                                                                                                                                                                                            
             10 Dico R?gido                                                          81         100          10 NULL                                                                                                                                                                                                                                                            
             11 Monitor                                                             300         100          10 NULL                                                                                                                                                                                                                                                            
...
Analise o código abaixo pra ver como chegamos a um sql pra resolver
   isso.
    ...
    #+begin_src sh :results output replace  :exports both
      docker exec sqlserver /opt/mssql-tools/bin/sqlcmd -S localhost -U SA -P Aluno#123 -i /sql_scripts/select_vendas_por_cada_cliente.sql
    #+end_src
    ...
    ----------- -------------------------------------------------- ---------------------------------------------------------------------------------------------------- --------------- ---------------------------------------------------------------------- ----------- ----------- ---------------- ---------- ---------- ----------
              3 Jeferson                                           Aguia Haia 123                                                                                       11-99999-9999   jef@dom.com                                                                      4           3       2018-02-10    1086.00        .00    1086.00
    ...
    --------------------- -------------------- -------------------------------------------------- ------------------ ----------- ----------- ----------- ----------
                        3                    3 Jeferson                                                            4           6           4           1      60.50
                        3                    3 Jeferson                                                            4           7           5           1     300.50
                        3                    3 Jeferson                                                            4           8           6           1     105.00
                        3                    3 Jeferson                                                            4           9           7           1      80.90
                        3                    3 Jeferson                                                            4          10           8           1    3002.00
    ...
    --------------------- -------------------- -------------------------------------------------- ------------------ ----------- -----------
                        ...
                        3                    3 Jeferson                                                            4           9           7
                        3                    3 Jeferson                                                            4          10           8
                        4                 NULL Carlos                                                           NULL        NULL        NULL
                        5                 NULL Ralf                                                             NULL        NULL        NULL
...
Vamos fazer isso...
    ...
    :  
    :   Agora vai a nossa query pra mostrar do lado direito os itens de cada compra
    : IdVendaDaTblVendas nomeCliente                                        VlrDaVenda                              
    : ------------------ -------------------------------------------------- ----------------------------------------
    :                  3 Jeferson                                                                            8466.50
    :                  4 Carlos                                                                              3548.90
    : 
