...
Vamos criá-lo...
    ...
    #+INCLUDE: "./sql_scripts/create_database.sql"
...
* Criação das tabelas
    ...
    #+INCLUDE: "./sql_scripts/create_tables.sql"
...
* Relacionamentos
  ...
  conhece, claro de tlbd1.
    ...
    #+INCLUDE: "./sql_scripts/create_contraints.sql"
...
já que o select mostra que a tabela venda não retornou registros.
    ...
    #+INCLUDE: "./sql_scripts/create_constraints_tests.sql"
...
Tabela de itens da compra do carlos
 ...
 #+TBLFM: @6$5=vsum(@2..@5)
    ...
    #+INCLUDE: "./sql_scripts/inserts.sql"
...
Analise o código abaixo pra ver como chegamos a um sql pra resolver
   isso.
    ...
    #+INCLUDE: "./sql_scripts/select_vendas_por_cada_cliente.sql"
...
Vamos fazer isso...
    ...
    #+INCLUDE: "./sql_scripts/select_agregacoes.sql"
