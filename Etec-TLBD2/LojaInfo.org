...
* Criacao do Banco de dados
  ...
  show databases do mysql, por exemplo.
    ...
    #+name: sp_databases
    #+begin_src sh :results output replace  :exports both
      docker exec sqlserver /opt/mssql-tools/bin/sqlcmd -S localhost -U SA -P Aluno#123 -i /sql_scripts/Exec_sp_databases.sql
    #+end_src
...
Vamos criá-lo...
    ...
    : Msg 1801, Level 16, State 3, Server 39dbf20408b6, Line 1
...
* Criação das tabelas
    ...
    #+begin_src sh :results output replace  :exports both
      docker exec sqlserver /opt/mssql-tools/bin/sqlcmd -S localhost -U SA -P Aluno#123 -i /sql_scripts/create_tables.sql
    #+end_src
...
A próxima sessão dessa atividade vai mostrar como resolver isso.
    ...
    ----------- -------------------------------------------------- ---------------------------------------------------------------------------------------------------- --------------- ----------------------------------------------------------------------
              1 jeferson                                           av eteczl 1                                                                                          11-99999-9999   email...                                                              
              2 jeferson                                           av eteczl 1                                                                                          11-99999-9999   email...                                                              
    ...
    ----------- -------------------------------------------------- -------------------- ----------- ----------- ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
              ...
              2 processador                                                          50          10          10 NULL                                                                                                                                                                                                                                                            
              3 placa mae                                                            50          10          10 NULL                                                                                                                                                                                                                                                            
              4 gabinete                                                             50          10          10 NULL                                                                                                                                                                                                                                                            
              5 processador                                                          50          10          10 NULL                                                                                                                                                                                                                                                            
              6 placa mae                                                            50          10          10 NULL                                                                                                                                                                                                                                                            
    ...
    ----------- ----------- ---------------- ---------- ---------- ----------
              ...
              2         500       2018-10-02      80.00      10.00      70.00
