...
* preparativos :noexport:
  ...
  #+RESULTS:
  : d306760168a10a184bd82b92f5c7671ca22c90e239f9007941c48ff3fc4e3d4e
  ...
  (0 rows affected)
  Msg 111, Level 15, State 1, Server d306760168a1, Line 10
  'CREATE TRIGGER' must be the first statement in a query batch.
  ###################################################
  #### inserindo um reg pra ver a trigger rodar  ####
  ###################################################
  Msg 8152, Level 16, State 4, Server d306760168a1, Line 7
  String or binary data would be truncated.
  The statement has been terminated.
  ###################################################
  #### select na nossa tbl de auditoria          ####
  ###################################################
  id_cliente  nome                                               endereco                                                                                             fone            email                                                                  acao_de_auditoria                                                                                    data_de_autidoria
  ----------- -------------------------------------------------- ---------------------------------------------------------------------------------------------------- --------------- ---------------------------------------------------------------------- ---------------------------------------------------------------------------------------------------- -----------------
