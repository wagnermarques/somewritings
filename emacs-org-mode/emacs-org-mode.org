...
1. O padrãozão pra inserir um bloco de código é...
...
2. Atalhos para inserção de blocos de código
...
2.1 pra customizar você pode colocar isso no seu arq de conf do emacs
