...
* Buildando e Executando o projeto
  ...
  saudação não é nula.
   ...
   #+RESULTS: buildando o projeto
   #+begin_example

   [36m[[m[34mwagner@cri4514[m [32mgradle_project[m[36m][m $ Downloading https://services.gradle.org/distributions/gradle-5.1.1-bin.zip
   ...
   #+BEGIN_SRC shell :session s1 :results output :exports both
      #starts code
      cd $GRADLE_PROJECT_DIR && ./gradlew tasks
   #+END_SRC
