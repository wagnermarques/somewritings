#+Title: Acessando os contatos do dispositivo com Cordova


* Tema
  Acessando os contatos do dispositivo com Cordova
...
** Explanacao Introdutoria do professor
** Parte Prática
*** Criação do projeto
    Crie o seu projeto
    Instale o plugin
...
* Exercicios e Atividades de Reflexão/Fixação
  Enviar link do codigo da parte pratica
